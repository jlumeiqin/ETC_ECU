 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Sun Jul  5 13:40:09 2015
*/
...
/* Output Port  1 */
#define OUT_PORT_1_NAME      dx1_com
...
/* Output Port  2 */
#define OUT_PORT_2_NAME      dx2_com
...
#define SOURCEFILES "__SFB__mpc.c"
#define PANELINDEX           6
...
extern void controller_Outputs_wrapper(const real_T *dx1,
			const real_T *dx2,
			const real_T *y,
			const real_T *u,
			const real_T *r,
...
{
    const real_T   *dx1  = (const real_T*) ssGetInputPortSignal(S,0);
    const real_T   *dx2  = (const real_T*) ssGetInputPortSignal(S,1);
    const real_T   *y  = (const real_T*) ssGetInputPortSignal(S,2);
    const real_T   *u  = (const real_T*) ssGetInputPortSignal(S,3);
    const real_T   *r  = (const real_T*) ssGetInputPortSignal(S,4);
    real_T        *du  = (real_T *)ssGetOutputPortRealSignal(S,0);
    real_T        *dx1_com  = (real_T *)ssGetOutputPortRealSignal(S,1);
    real_T        *dx2_com  = (real_T *)ssGetOutputPortRealSignal(S,2);


    controller_Outputs_wrapper(dx1, dx2, y, u, r, du, dx1_com, dx2_com);
