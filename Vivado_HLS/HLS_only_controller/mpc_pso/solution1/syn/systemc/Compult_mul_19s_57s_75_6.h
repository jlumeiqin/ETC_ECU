...
#ifndef __Compult_mul_19s_57s_75_6__HH__
#define __Compult_mul_19s_57s_75_6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Compult_mul_19s_57s_75_6) {
    ...
    SC_CTOR(Compult_mul_19s_57s_75_6):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
