...
#ifndef __Compult_mul_20s_20ns_40_3__HH__
#define __Compult_mul_20s_20ns_40_3__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Compult_mul_20s_20ns_40_3) {
    ...
    SC_CTOR(Compult_mul_20s_20ns_40_3):  ACMP_mul_su_U ("ACMP_mul_su_U") {
