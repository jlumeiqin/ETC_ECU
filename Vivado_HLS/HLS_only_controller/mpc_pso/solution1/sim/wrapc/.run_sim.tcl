...
set ::env(PATH) "$::env(PATH);D:/Xilinx/Vivado_HLS/2014.4/win32/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);D:/Xilinx/Vivado_HLS/2014.4/win32/tools/opencv"
set ::env(PATH) "$::env(PATH);D:/Xilinx/Vivado_HLS/2014.4/win32/tools/fft_v9_0"
set ::env(PATH) "$::env(PATH);D:/Xilinx/Vivado_HLS/2014.4/win32/tools/fir_v7_0"
...
upvar ::AESL_AUTOSIM::DirAutoSimRoot  DirAutoSimRoot
    ...
    set gWorkingDir             "../.."
    set constFileTvIn           "Compult.autotvin.dat"
    set constFileTvOut          "Compult.autotvout.dat"
    set constFileHdlTvIn        "Compult.autohdltvin.dat"
    set constFileHdlTvOut       "Compult.autohdltvout.dat"
    set gGateLevelSim           "0"
    set gAutowrap               "1"
    set gTool                   "modelsim"
